...
public class julFragment extends Fragment {
    ...
    String url = "http://smvitmapp.xtoinfinity.tech/php/getcalendarevent.php?month=07";


    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        view= inflater.inflate(R.layout.fragment_jul, container, false);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        if(response.equals("no")){
                            Toast.makeText(getActivity(), "No events during this month", Toast.LENGTH_SHORT).show();
                        }else {
                            parseItems(response);
                        }
                    }
